...
# Implementacion de la solucion que utiliza un arbol de segmentos para
# consultar el LCA en O(log n) y evaluar forall y exists en O(log n) si el arbol es balanceado
# o O(n) en el peor caso si el arbol es una lista
class LogicTree():
